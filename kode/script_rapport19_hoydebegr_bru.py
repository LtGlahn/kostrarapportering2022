...
skrivdataframe.skrivdf2xlsx( telling, '../kostraleveranse2022/Kostra 19 - Bruer hoyde mindre enn 4m.xlsx', sheet_name='Bru høydebegrensning under 4m', metadata=mittfilter)
