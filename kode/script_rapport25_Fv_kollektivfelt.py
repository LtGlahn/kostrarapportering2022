...
skrivdataframe.skrivdf2xlsx( statistikk, '../kostraleveranse2022/Kostra 25 - Fylkesveg med kollektivfelt.xlsx', sheet_name='Fylkesveg med kollektivfelt', metadata=mittfilter)
