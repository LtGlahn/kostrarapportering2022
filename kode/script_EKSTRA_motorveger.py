...
metadata = { 'tidspunkt' : '2022-12-31', 'Kryssdeler' : 'Kryssdeler filtrert vekk', 'Sideanlegg' : 'Sideanlegg filtrert vekk', 'Ramper' : 'Ramper filtrert vekk', 'trafikantgruppe' : 'K' }
skrivdataframe.skrivdf2xlsx( telling, '../kostraleveranse2022/EKSTRARAPPORT motorveger.xlsx', sheet_name='Motorveger', metadata=metadata )
