...
skrivdataframe.skrivdf2xlsx( lengde, '../kostraleveranse2022/Kostra 02 - Fylkesveg med motorveg og motortrafikkveg.xlsx', sheet_name='Fv med motor(trafikk)veg', metadata=mittfilter)
