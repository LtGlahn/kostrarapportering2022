...
skrivdataframe.skrivdf2xlsx( [ skjermlengde, volllengde ], '../kostraleveranse2022/Kostra 24 - Fylkesveg med stoyskjerm og voll.xlsx', sheet_name=['Fylkesveg med støyskjerm', 'Fylkesveg med voll' ], metadata=mittfilter)
