...
veger = veger[ veger['d1'] <= datetime( 2020, 12, 31 ) ]
veger = veger[ veger['d2'] >  datetime( 2020, 12, 31 ) ]
...
skrivdataframe.skrivdf2xlsx( [telling2,             telling,               lengde], '../kostraleveranse2022/Kostra 20 - Midtrekkverk to og trefelts Fv.xlsx', 
