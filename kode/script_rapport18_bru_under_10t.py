...
skrivdataframe.skrivdf2xlsx( telling, '../kostraleveranse2022/Kostra 18 - Bruer under 10t.xlsx', sheet_name='Bru aksellast under 10t', metadata=mittfilter)

tidsbruk = datetime.now() - t0 
print("tidsbrukt rapport 18", tidsbruk)